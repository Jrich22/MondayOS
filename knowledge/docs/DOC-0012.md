...
## Active increment (DEC-0008, 2026-07-22)
**Event Planning** is the active next increment (decision `DEC-0008`; product
definition `DOC-0015`; scoped under the Event Workspace epic `TASK-0020`).
**Invite & RSVP** (`TASK-0023`) is the planned successor — the next
high-priority lifecycle gap after the Event Planning foundation, unless new
customer evidence changes the order. This records sequence only; it does not
